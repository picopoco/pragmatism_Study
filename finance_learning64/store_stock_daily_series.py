...
def create_table(conn):
    conn.execute(
        "CREATE TABLE IF NOT EXISTS stock_daily_series(code TEXT, date DATE, open INTEGER, high INTEGER, low INTEGER, close INTEGER, volume INTEGER, hold_foreign REAL, st_purchase_inst REAL, PRIMARY KEY(code, date))")
